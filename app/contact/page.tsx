...
export default function ContactPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const whatsappNumber = '8129467976'; // Example: +1 (555) 123-4567
  ...
  return (
    <div className="min-h-screen  py-12 px-4 sm:px-6 lg:px-8">
       <head>
        <title>Contact Us - Stylezone Store</title>
        <meta name="description" content="Contact Page of Stylezone store." />
      </head>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Kerala</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">nnnirfan082@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+91 8129467976</p>
                  </div>
                </div>
              </CardContent>
            </Card>
